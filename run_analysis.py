...
def main():
    logging.info("Running return-risk analysis pipeline...")
    ...
    logging.info("Training Ridge regression model (alpha=2.976)...")
    ...
    logging.info("Model saved to models/ridge_model.pkl")
    
    # 5. Feature importance plot (coefficients)
    ...
    # 7. Error by price tier (where does the model fail?)
    ...
    # 8. 3-year NPV business case (30,000 annual returns, enterprise scale)
    ...
    print(f"\nBase-case NPV ($20/return, 10% reduction, 30k returns/yr): ${npv_20:,.2f}\n")
